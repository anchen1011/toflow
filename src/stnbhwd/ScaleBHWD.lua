...
function ScaleBHWD:updateOutput(input)
   ...
   inputImages.nn.ScaleBHWD_updateOutput(self, inputImages, grids, self.output)
...
function ScaleBHWD:updateGradInput(_input, _gradOutput)
   ...
   inputImages.nn.ScaleBHWD_updateGradInput(self, inputImages, grids, gradInputImages, gradGrids, gradOutput)
